	...
	<body>
		<div class="container-fluid">
			...
			<div class="row">
				...
				<article class="col-sm-8 col-sm-push-2">
					<p class="yumeindexarticle">

					</p>
				</article>
				<aside class="col-sm-4 col-sm-push-8" id="historique">
					</br>
					<form method="post" action="">
						<p class="recherche">
						<label for="email"></label>Votre Email:<br/>
						<input type="email" name="email" id="email" placeholder="Ex: yumejoin@mail.com"/>
						</p>
					</form>
				</aside>


			<aside class="col-sm-2 col-sm-pull-10" id="yumesearch"><p>Publicité</p>
			...
			<footer class="row">
						...
						<div class="col-sm-4">
							...
							<p><a href="https:my.w.tt/LDyLaCkWK7">Wattpad</a></p>
							<p><a href="https://www.facebook.com/107057034005845/posts/144885186889696/?app=fbl">Facebook</a></p>
							<p><a href="https://discord.gg/ZpETCzB">Discord</a></p>
							<p><a href="https://www.instagram.com/yumenewsofficiel">Instagram</a></p>
						</div>
						<div class="col-sm-4">
